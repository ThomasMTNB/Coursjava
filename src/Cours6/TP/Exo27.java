...
public class Exo27 {
    public static void main(String[] args) {
        PatientClass patient1 = new PatientClass("Meun", "Tom", 1.75F, 63, 29);

        PatientClass patient2 = new PatientClass();
...
// refaire avec des constructeurs defautdefautdefautdefaut.


// e but de cet exercice est de créer des « patients » qui ont un poids et une taille,et de calculer leur « Indice de Masse Corporelle» (IMC).
//crée un patient,
